...
const Footer = () => {
  ...
  return (
    <>
      ...
      {/* Desktop Footer */}
      <footer className="hidden sm:block bg-black text-white py-12 mt-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex gap-4">
                {/* Twitter Icon */}
                <a href="https://twitter.com" target="_blank" className="text-gray-400 hover:text-white transition duration-150">
                ...
                {/* Facebook Icon */}
                <a href="https://facebook.com" target="_blank" className="text-gray-400 hover:text-white transition duration-150">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                ...
                {/* Instagram Icon */}
                <a href="https://instagram.com" target="_blank" className="text-gray-400 hover:text-white transition duration-150">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
